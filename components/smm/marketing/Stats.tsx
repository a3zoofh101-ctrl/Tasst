...
export async function Stats() {
  ...
  return (
    <section className="px-4 py-14 sm:px-6 sm:py-20">
      <div className="smm-glass mx-auto grid max-w-5xl grid-cols-2 gap-4 rounded-3xl p-6 sm:grid-cols-4 sm:p-10">
        {items.map((s) => (
          <div key={s.label} className="text-center">
            <p className="bg-brand-gradient bg-clip-text text-2xl font-extrabold text-transparent sm:text-4xl">{formatNumber(s.value)}+</p>
